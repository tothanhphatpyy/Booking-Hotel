...
InsideRouteScreenProps<ScreensName.RoomInfoScreen>> = () => {
  ...
  return (
    <View style={{}}>
      ...
      {/*  Tab Bottom */}
      {hideBottom? null :
      <View style={{ position: 'absolute', height: 100, left: 0, top: windowHeight - 100, width: windowWidth,
      borderTopWidth: 1.5, borderTopColor: '#DCDCDC', backgroundColor: 'white' }}>
        <View style={{ flexDirection: 'row', marginTop: 10, alignItems: 'center', justifyContent: 'space-between', marginHorizontal: 20}}>
          ...
          <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', marginTop: 4 }}
                          onPress ={() => navigate('InsideRoute', {screen : ScreensName.ConfirmRoomScreen, params: {idRoomOder : idRoomSuggest}})}>  
            <LinearGradient
